// dibawahh ini adalah fungsi untuk bekerja dengan module fs pada NodeJS
const fs = require('fs');

// adapun data yang telah disediakan sekarang dimasukan pada fungsi const data
const data = 
...
// dibawah ini adalah fungsi untuk membuat dan menulis data pada file log.txt
fs.writeFileSync('log.txt', data, { flag: 'w' }, (err) => {
  if (err) {
